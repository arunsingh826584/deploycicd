...
?>
	...
	<head>
		<title>GLAU Badminton | Admin Dashboard</title>
					...
					<div class="four-grids">
						...
						<div class="col-md-3 four-grid">
							<div class="four-agileinfo">
								...
								<div class="four-text">
									<h3>Alumni Corner</h3>
									<?php $sql1 = "SELECT alumniid  from alumnicorner";
						...
						<div class="col-md-3 four-grid">
							<div class="four-w3ls">
								...
								<div class="four-text">
									<h3>Contact</h3>
									<?php $sql2 = "SELECT id from contact";
						...
						<div class="col-md-3 four-grid">
							<div class="four-wthree">
								...
								<div class="four-text">
									<h3>Last Event Winner</h3>
									<?php $sql3 = "SELECT id from lasteventwinner";
					...
					<div class="four-grids">
						<div class="col-md-3 four-grid">
							<div class="four-w3ls">
								...
								<div class="four-text">
									<h3>Members</h3>
									<?php $sql5 = "SELECT id from members";
